...
export const roleConfigs: Record<string, RoleConfig> = {
  ...
  aqad: {
    ...
    navItems: [
      ...
      { label: "Audits", href: "/aqad/audits", icon: CalendarCheck },
      { label: "Standards", href: "/aqad/standards", icon: BookMarked },
      ...
      { label: "Audit Trail", href: "/aqad/audit-trail", icon: ScrollText },
      { label: "Team", href: "/aqad/team", icon: Users },
      { label: "Settings", href: "/aqad/settings", icon: Settings },
    ],
  },
  resource: {
    role: "resource",
  ...
  deputy: {
    ...
    navItems: [
      ...
      { label: "Attendance", href: "/deputy/attendance", icon: Clock },
      { label: "Financial", href: "/deputy/financial", icon: Wallet },
      { label: "Quality", href: "/deputy/quality", icon: ShieldCheck },
      { label: "Resources", href: "/deputy/resources", icon: Users },
      { label: "Progression", href: "/deputy/progression", icon: TrendingUp },
      { label: "Comparative", href: "/deputy/comparative", icon: GitCompare },
      ...
      { label: "Settings", href: "/deputy/settings", icon: Settings },
    ],
  },
  admin: {
    role: "admin",
